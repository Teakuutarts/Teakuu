...
module.exports = THREE => {
  ...
  const headBox = (() => {
    const headTop = [
      new THREE.Vector2(0.125, 0.875),  //1
      new THREE.Vector2(0.25, 0.875),   //2
      new THREE.Vector2(0.25, 1),       //3
      new THREE.Vector2(0.125, 1)       //4
    ];
    const headBottom = [
      new THREE.Vector2(0.25, 0.875),   //2
      new THREE.Vector2(0.375, 0.875),  //5
      new THREE.Vector2(0.375, 1),      //6
      new THREE.Vector2(0.25, 1)        //3
    ];
    const headLeft = [
      new THREE.Vector2(0, 0.75),       //7
      new THREE.Vector2(0.125, 0.75),   //8
      new THREE.Vector2(0.125, 0.875),  //1
      new THREE.Vector2(0, 0.875)       //9
    ];
    const headFront = [
      new THREE.Vector2(0.125, 0.75),   //8
      new THREE.Vector2(0.25, 0.75),    //10
      new THREE.Vector2(0.25 ,0.875),   //12
      new THREE.Vector2(0.125 ,0.875)   //13
    ];
    const headRight = [
      new THREE.Vector2(0.25, 0.75),    //10
      new THREE.Vector2(0.375, 0.75),   //14
      new THREE.Vector2(0.375, 0.875),  //5
      new THREE.Vector2(0.25, 0.875)    //2
    ];
    const headBack = [
      new THREE.Vector2(0.375, 0.75),   //14
      new THREE.Vector2(0.5, 0.75),     //15
      new THREE.Vector2(0.5, 0.875),    //16
      new THREE.Vector2(0.375, 0.875)   //5
    ];
