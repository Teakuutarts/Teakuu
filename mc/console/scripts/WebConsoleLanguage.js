	...
	switch(locale){
		case "en_US":
			lang = {
				...
				"home_description": "If the web version does not work, please download the client.",
				"serversDropdown": "Servers",
				...
				"addServerModalSvPort": "Console port:",
				...
				"disconnectionModalWelcomeScreenButton": "Back to home page",
				"settingsLink": "Settings",
				"settingsModalLongTitle": "TeakuuWebConsole Settings",
